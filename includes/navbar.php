...
<aside id="primary-sidebar" class="sidebar" aria-label="Primary navigation">
  ...
  <nav class="sidebar-nav">
    <?php if (is_admin()): ?>
      <a class="sidebar-link<?= $isAdmin ? ' active' : '' ?>" href="admin.php" data-nav-link<?= $isAdmin ? ' aria-current="page"' : '' ?> data-section="admin">
      ...
      <a class="sidebar-link<?= $isAnnouncements ? ' active' : '' ?>" href="announcements.php" data-nav-link<?= $isAnnouncements ? ' aria-current="page"' : '' ?> data-section="announcements">
        <span class="sidebar-icon" aria-hidden="true">
    ...
    <?php else: ?>
      ...
      <a class="sidebar-link<?= $isHome ? ' active' : '' ?>" href="<?= $homeHref ?>" data-section="hero" data-nav-link<?= $isHome ? ' aria-current="page"' : '' ?>>
        <span class="sidebar-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24" role="presentation" focusable="false">
      ...
      <a class="sidebar-link<?= $isCreateReport ? ' active' : '' ?>" href="create-report.php" data-nav-link<?= $isCreateReport ? ' aria-current="page"' : '' ?>>
        <span class="sidebar-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24" role="presentation" focusable="false">
      ...
      <a class="sidebar-link<?= $isDashboard ? ' active' : '' ?>" href="dashboard.php" data-nav-link<?= $isDashboard ? ' aria-current="page"' : '' ?>>
        <span class="sidebar-icon" aria-hidden="true">
          <svg viewBox="0 0 24 24" role="presentation" focusable="false">
            <path d="M4 4h6v6H4zm10 0h6v10h-6zm-10 10h6v6H4zm10 4h6v2h-6z" />
          </svg>
